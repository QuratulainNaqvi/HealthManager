...
import com.crazytrends.healthmanager.BMR.bmr_calculator;
import com.crazytrends.healthmanager.Body_Surface_Area_Calculator.C1376Body_Surface_Area_Calculator;
import com.crazytrends.healthmanager.R;
import com.crazytrends.healthmanager.alcohol.Alcohol_Calculator;
import com.crazytrends.healthmanager.blood_donation.Blood_Donation_Calculator;
import com.crazytrends.healthmanager.blood_pressure.BloodPressure_Calculator;
import com.crazytrends.healthmanager.blood_volume.Blood_Volume_Calculator;
import com.crazytrends.healthmanager.bmi.BMI_Calculator;
import com.crazytrends.healthmanager.body_adiposity_index.Body_Adiposity_Index_Calculator;
import com.crazytrends.healthmanager.body_fat.Bodyfat_Calculator;
import com.crazytrends.healthmanager.body_frame_size.Body_Frame_Size_Calculator;
import com.crazytrends.healthmanager.calories_burn.Calories_burn_Calculator;
import com.crazytrends.healthmanager.calories_intake.Daily_Calories_Intake_Calculator;
import com.crazytrends.healthmanager.chest_hip_ratio.Chest_Hip_Ratio_Calculator;
import com.crazytrends.healthmanager.child_growth.Child_Growth_Calculator;
import com.crazytrends.healthmanager.children_height_growth.Children_Height_Growth_Prediction_Calculator;
import com.crazytrends.healthmanager.cholestrol.Cholestrol_Calculator;
import com.crazytrends.healthmanager.daily_water.Daily_WaterIntake_Calculator;
import com.crazytrends.healthmanager.heart_rate.Heart_Rate_Calculator;
import com.crazytrends.healthmanager.ideal_body_weight.Ideal_Body_Weight_Calculator;
import com.crazytrends.healthmanager.lean_body_mass.Lean_Body_Mass_Calculator;
import com.crazytrends.healthmanager.menstrual_and_ovulation.Menstrual_Ovulation_Calculator;
import com.crazytrends.healthmanager.pregnancy_due_date.Pregnancy_Due_Date_Calculator;
import com.crazytrends.healthmanager.smoking_risk.Smoking_Risk_Calculator;
import com.crazytrends.healthmanager.sugar.Sugar_calculator;
import com.crazytrends.healthmanager.trademill.Trademill_Calculator;
import com.crazytrends.healthmanager.utils.TypefaceManager;
import com.crazytrends.healthmanager.waist_height_ratio.Waist_Height_Ratio_Calculator;
import com.crazytrends.healthmanager.waist_hip_ratio.Waist_Hip_Ratio_Calculator;
            ...
            myRestaurant_ViewHolder.rl_home.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    ...
                    if (i == 0) {
                        ...
                        Intent intent2 = new Intent(Home_Adapter.this.activity, Bodyfat_Calculator.class);
                        ...
                        Intent intent3 = new Intent(Home_Adapter.this.activity, BloodPressure_Calculator.class);
                        ...
                        Intent intent4 = new Intent(Home_Adapter.this.activity, Sugar_calculator.class);
